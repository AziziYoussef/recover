...
export default function ReportLostPage() {
  ...
  const onSubmit = async (data: ReportFormValues) => {
    if (status === "unauthenticated") {
      ...
      sessionStorage.setItem("reportLostFormData", JSON.stringify(data))
      router.push("/auth/signin?callbackUrl=/report-lost&reason=report")
      return
    }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {success && (
          <Alert className="mb-6 border-green-500 bg-green-50 text-green-700">
            <AlertDescription>
              Your lost item has been reported successfully! Redirecting to map...
            </AlertDescription>
          </Alert>
        )}
        ...
        <Card className="transform-gpu">
          <CardHeader>
            ...
            <CardDescription>
              Provide as much information as possible to help someone find your lost item
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  {showLocationPicker && (
                    <div className="mt-4">
                      <LocationPicker
                        ...
                        placeholder="Cliquez sur la carte pour sélectionner le lieu où vous avez perdu l'objet"
                      />
                    </div>
                  )}
                </div>
